    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center py-10">
      ...
      <div className="mt-8 flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-[#11b67a] text-black p-6 rounded-2xl shadow-lg flex-1 flex flex-col min-h-[400px]">
          <div className="h-24">
            <img src={calculator} className="w-24 h-24" />
          </div>
          ...
          <button className="mt-auto bg-black text-white px-4 py-2 rounded-lg w-full font-bold">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg flex-1 flex flex-col min-h-[400px]">
          <div className="h-24">
            <img src={application} className="w-24 h-24" />
          </div>
          <div className="flex items-center gap-3 h-16 mb-3">
          ...
          <button className="mt-auto border border-black text-black px-4 py-2 rounded-lg w-full">
